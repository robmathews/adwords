...
export class BamlAsyncClient {
  ...
  async GenerateDemographics(
    ...
    try {
      ...
      return raw.parsed(false) as Demographics[]
    } catch (error) {
  ...
  async SimulateResponse(
    ...
    try {
      ...
      return raw.parsed(false) as LLMResponse
    } catch (error) {
      throw toBamlError(error);
    }
  }
...
class BamlStreamClient {
  ...
  ): BamlStream<(partial_types.Demographics | null)[], Demographics[]> {
    try {
      const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
      const collector = options.collector ? (Array.isArray(options.collector) ? options.collector : [options.collector]) : [];
      ...
      return new BamlStream<(partial_types.Demographics | null)[], Demographics[]>(
        raw,
        (a): (partial_types.Demographics | null)[] => a,
        (a): Demographics[] => a,
        this.ctxManager.cloneContext(),
      )
    } catch (error) {
  ...
  SimulateResponse(
      input: SimulationInput,
      __baml_options__?: { tb?: TypeBuilder, clientRegistry?: ClientRegistry, collector?: Collector | Collector[] }
  ): BamlStream<partial_types.LLMResponse, LLMResponse> {
    try {
      const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
      const collector = options.collector ? (Array.isArray(options.collector) ? options.collector : [options.collector]) : [];
      const raw = this.runtime.streamFunction(
      ...
      return new BamlStream<partial_types.LLMResponse, LLMResponse>(
        raw,
